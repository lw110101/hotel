	...
	<div id="MainArea">
				...
				<c:when test="${not empty requestScope.foodTypeList }">
					<c:forEach var="foodType" items="${requestScope.foodTypeList }">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath }/FoodTypeServlet?method=viewUpdate&id=${foodType.id }" class="FunctionButton">更新</a> 
								<a href="${pageContext.request.contextPath }/FoodTypeServlet?method=delete&id=${foodType.id }" class="FunctionButton">删除</a>
							</td>
						</tr>
						</c:forEach>
					</c:when>
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="${pageContext.request.contextPath }/sys/type/foodType_add.jsp">添加</a>
			</div>
		</div>
	</div>
</body>
