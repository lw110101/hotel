...
<div id="TitleArea">
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/FoodServlet?method=searchFood" method="post">
...
<div id="MainArea">
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${pageContext.request.contextPath }/FoodServlet?method=getAllFoodTypes">添加</a></div>
    </div> 
</div>
</body>
</html>
